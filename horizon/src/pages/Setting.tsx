...
const Setting = () => {
  ...
  // ── Tab change handler ───────────────────────────────────────
  // Jab user kisi tab button pe click kare
  ...
  return (
    <div className="space-y-4">
      ...
      {/* ── Tab Buttons ── */}
      {/* Yeh buttons hain — click karne pe URL change hoga */}
      <div className="flex items-center gap-1 bg-slate-100 p-1 rounded-xl w-fit">
        {TABS.map((tab) => {

          // Kya yeh tab abhi active hai? URL se check karo
          ...
          return (
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 cursor-pointer ${
                isActive
                  ? "bg-white text-slate-800 shadow-sm"   // active tab: white + shadow
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {/* ─── Profile Tab ─── */}
        {/* activeTab === "profile" toh dikhao, warna hide */}
        {activeTab === "profile" && (
